...
const CONTRACT_NAME = "LuckyDice";

// Root of the Hardhat project (one level above frontend)
const rel = "..";
...
if (!fs.existsSync(dir)) {
  console.error(`${line}Unable to locate project root at ${rel}.${line}`);
  process.exit(1);
}
